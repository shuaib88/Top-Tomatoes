//
//  MovieDetailinScrollViewController.swift
//  TopTomatoes
//
//  Created by Shuaib Ahmed on 3/18/16.
//  Copyright © 2016 Shuaib Labs. All rights reserved.
//

import UIKit

class MovieDetailinScrollViewController: UIViewController {
...
//        scrollView.backgroundColor = UIColor.clearColor()
        scrollView.contentSize.width = 367
        scrollView.contentSize.height = 667 * 2
//
//        scrollView.autoresizingMask = UIViewAutoresizing.FlexibleHeight
//        
//        scrollView.addSubview(movieTitle)
//        scrollView.addSubview(movieImage)
//        scrollView.addSubview(plotSummary)
//        
